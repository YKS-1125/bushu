...
# 平台注入 PORT 环境变量（HF Spaces=7860 / Render/Railway 各自注入）；本地默认 7860
EXPOSE 7860
...
CMD gunicorn --bind "0.0.0.0:${PORT:-7860}" --workers ${WEB_CONCURRENCY:-1} --threads 8 --timeout 120 app:app
